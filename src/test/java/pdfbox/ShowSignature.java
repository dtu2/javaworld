...
public class ShowSignature {
    ...
    public static void main(String[] args) throws Exception {
        ...
        show.showSignature("src/test/resources/data/pdf/sample.pdf");
    }

    private void showSignature(String args) throws Exception {
//        String password = args[0];
        String infile = args;
        File pdfFile = new File(infile);
    ...
    private static void usage() {
        System.err.println("usage: java org.apache.pdfbox.examples.signature.ShowSignature " + "<password> <inputfile>");
    }
